...
assert(fs.statSync(readingFont).size < 2 * 1024 * 1024, 'the approved reading font should remain under 2 MiB after WOFF2 compression');
assert(styles.includes('changerwencai.woff2') && styles.includes('format("woff2")'), 'styles should use the compressed approved reading font');
